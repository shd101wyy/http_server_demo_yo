{
  ...
  version = "1.11.1";
  system = "x86_64-linux";
  devenv_root = "/home/yiyiwang/Workspace/http_server_demo_yo";
  project_input_ref = "path:/home/yiyiwang/Workspace/http_server_demo_yo";
  devenv_dotfile = "/home/yiyiwang/Workspace/http_server_demo_yo/.devenv";
  devenv_dotfile_path = ./.devenv;
  devenv_tmpdir = "/run/user/1000";
  devenv_runtime = "/run/user/1000/devenv-a658d0f";
  ...
  hostname = "nixos";
  username = "yiyiwang";
  git_root = "/home/yiyiwang/Workspace/http_server_demo_yo";
  secretspec = null;
};
    in
    {
